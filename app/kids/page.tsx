...
import { BOOKING_URL, PHONE_DISPLAY, PHONE_HREF, SITE_URL, SUMMER_OFFER } from "@/lib/site";
        ...
        <section className="py-12 px-4 bg-pma-navy">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-blue-200 text-lg mb-8 max-w-lg mx-auto">
              Get your child started this summer with {SUMMER_OFFER.weeks} weeks of classes, a free
              uniform, and no registration fee.
            </p>
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm mx-auto">
              <p className="text-6xl font-extrabold mb-1 text-pma-navy">{SUMMER_OFFER.youthPrice}</p>
